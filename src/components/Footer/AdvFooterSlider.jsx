...
const AdvFooterSlider = () => {
  ...
  return (
    ...
    >
      <div className="s7upf-slider adv-footer-slider mt-10 flex flex-row justify-around pl-2">
        {items.map((item, index) => (
          <div
            className="item-adv-footer relative mr-10 flex h-[200px]  flex-col"
            key={index}
          >
            <div className="group">
              <div className="info-adv-footer relative hidden group-hover:block group-hover:animate-rotate">
                ...
                <div className="absolute right-0 mb-3 ">
                  <img
                    src="https://matpetfamily.com/wp-content/themes/haustiere/assets/css/images/icon/arrow.png"
                    alt="arrow"
                  />
                </div>
              </div>

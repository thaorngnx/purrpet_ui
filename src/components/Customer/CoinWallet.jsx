    ...
    return (
       ...
       <Box className="m-5 w-full bg-white">
        <FormGroup className="flex flex-row m-10 items-center">
            ...
            gutterBottom
            component="div"
            className="ml-3 text-[20px] sm:text-[22px] md:text-[24px] lg:text-[26px] xl:text-[28px] text-[#f6a700]"
            >
            ...
            gutterBottom
            component="div"
            className="ml-3 mt-[14px] text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] text-[#f6a700]"
            >
            Xu đang có
            <Typography className="text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px] text-black">
        ...
        <Box>
            ...
            <Box
                key={coin.id}
                className="flex flex-row justify-between items-center border-b-2 border-gray-200 p-2"
            >
                <img
                ...
                className="w-[50px] sm:w-[60px] md:w-[70px] lg:w-[80px] xl:w-[90px]"
                />
                <Typography variant="body1" className="w-3/5 text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">
                {coin.status === 'cộng'
                ...
                <Typography
                variant="body1"
                className={`text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] ${coin.status === 'cộng' ? 'text-[#f6a700]' : 'text-black'} text-end w-1/5`}
                >
                {coin.status === 'cộng'
